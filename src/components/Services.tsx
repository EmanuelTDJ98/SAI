...
const services = [
  {
    ...
    description: "Diseño técnico personalizado de sistemas HVAC-R. Cálculo de cargas térmicas, selección de equipos y planos de instalación según normativa vigente.",
    image: Plano,
  
  },
  {
    title: "Venta de Equipos",
    description: "Suministro de equipos de climatización de marcas líderes. Asesoría especializada para seleccionar la solución más eficiente para su proyecto",
    image: Equipo,
    
  },
  {
    title: "Instalaciones Profesionales",
    description: "Montaje e instalación de sistemas completos con personal certificado. Puesta en marcha, pruebas de rendimiento y entrega llave en mano.",
    image: instalacion,
  },
  {
    title: "Mantenimiento Preventivo",
    description: "Planes de mantenimiento programado para garantizar eficiencia y vida útil. Servicio técnico especializado disponible 24/7 para emergencias.",
   image: mantenimiento,
  },
];
    ...
    <section className="py-24 bg-slate-50 overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center mb-32">
          ...
          >
            <p className="leading-relaxed">
              <span className="text-sai-turquesa font-bold">SAI</span> es una empresa líder en soluciones
              integrales de climatización, especializada en el diseño, instalación y mantenimiento de
              sistemas <span className="text-black font-semibold">HVAC-R</span> para el sector comercial e industrial.
            </p>
            <p className="leading-relaxed">
              Con un equipo de ingenieros certificados y técnicos especializados, garantizamos
              eficiencia energética, confort térmico y operación continua de sus instalaciones.
            </p>
            <p className="leading-relaxed border-l-4 border-sai-turquesa pl-6 py-2">
              Nuestra experiencia abarca desde pequeñas oficinas hasta grandes complejos industriales,
              siempre con el más alto estándar de calidad.
            </p>
          </motion.div>
          ...
          <motion.div 
            ...
            className="md:col-span-2 relative h-[450px] md:h-[500px]"
          >
        ...
        <div className="text-center mb-12">
           <h3 className="text-3xl font-bold text-white mb-2">Soluciones Profeciones en Climatización</h3>
